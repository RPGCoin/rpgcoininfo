...
coins.forEach(function (coin) {
  ...
  coin.main.toRPGcoinJS = toRPGcoinJS.bind(coin.main)
  coin.main.toRPGcore = toRPGcore.bind(coin.main)
  supportedCoins[unit] = coin.main
  supportedCoins[name] = coin.main

  if (coin.test) {
    coin.test.testnet = true
    coin.test.toRPGcoinJS = toRPGcoinJS.bind(coin.test)
    coin.test.toRPGcore = toRPGcore.bind(coin.test)
  ...
  if (coin.regtest) {
    ...
    coin.regtest.toRPGcoinJS = toRPGcoinJS.bind(coin.regtest)
    coin.regtest.toRPGcore = toRPGcore.bind(coin.regtest)
